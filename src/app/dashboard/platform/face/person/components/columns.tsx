...
export const columns: ColumnDef<FacePerson>[] = [
  {
    id: "select",
    header: ({ table }) => (
  ...
  },
  {
    ...
    header: ({ column }) => <DataTableColumnHeader column={column} title="人员编码" />,
    cell: ({ row }) => {
      return (
        <div className="flex space-x-2">
          <span className="max-w-[200px] truncate">
            {row.getValue("person_code")}
          </span>
        </div>
      )
    },
  ...
  {
    accessorKey: "library",
    header: ({ column }) => <DataTableColumnHeader column={column} title="所属人脸库" />,
    cell: ({ row }) => {
